...
- **TESTED (automated):** 411 unit tests across 22 files in `tests/lib/` covering roll-helpers (121), roll-outcomes (34), community-logic (29), fuel-storage (21), safe-upload (20), brewing-supplies (19), first-impression-resolver (18), xse-engine (18), cdp-costs (17), damage (15), advantages (14), npc-drag-drop (12), distract-helpers (11), sentry-filters (11), encumbrance (10), stabilize-helpers (10), supabase-errors (8), playtest-recorder (6), rolls-feed-collapse (6), sentry-realtime (5), image-utils (3), signed (3). Suite runs in ~479ms on every commit + every push to main. (Auto-refreshed 2026-05-20 via `scripts/refresh-ledger.mjs`.)
