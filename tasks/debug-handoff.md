...
- **TESTED (automated):** 476 unit tests across 24 files in `tests/lib/` covering roll-helpers (121), roll-outcomes (48), damage-payload (40), community-logic (29), fuel-storage (21), safe-upload (20), brewing-supplies (19), first-impression-resolver (18), xse-engine (18), cdp-costs (17), damage (15), advantages (14), encumbrance (13), npc-drag-drop (12), distract-helpers (11), sentry-filters (11), stabilize-helpers (10), gut-instinct-helpers (8), supabase-errors (8), playtest-recorder (6), rolls-feed-collapse (6), sentry-realtime (5), image-utils (3), signed (3). Suite runs in ~525ms on every commit + every push to main. (Auto-refreshed 2026-05-21 via `scripts/refresh-ledger.mjs`.)
