...
- [ ] **Phase 2 (5 left of 7):** ~~char-create methods~~ (#8) + ~~session lifecycle~~ (#9) DONE; remaining: combat flow+propagation, NPC roster CRUD + recruit gates, communities lifecycle + weekly check, inventory/trade, rumors publish->clone (+ ~5 small `data-testid`s).
