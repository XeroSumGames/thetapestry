...
- [ ] **[MEDIUM][HP] AUDIT M1 - close security carry-over** at `app/scene-controls-popout/page.tsx:316` - add `prepareUpload('tactical-maps', file)` + register `tactical-maps` in `lib/safe-upload.ts` BUCKETS. ~15 min.
