...
- [ ] **[HIGH][PUFFER] AUDIT H2 - refresh Confidence Ledger** via `node scripts/refresh-ledger.mjs`; ledger says 622/37, actual 738/41. Health-pulse has flagged this 6+ days. ~5 min.
- [ ] **[HIGH][PUFFER] AUDIT H3 - HOPED-FOR drain** post-Minnie-S7 + post-12-check-gate. Update `debug-handoff.md` §3 to reflect what's verified vs hoped-for in the 2026-05-19 / 2026-05-25 / 2026-05-30 batches. ~30 min.
- [ ] **[HIGH][PUFFER doc + HP campaign] AUDIT H1 - Tech Debt Ledger §2 "as any" entry** reflects 2 sites; reality is ~557 across the codebase (table-page 108, RollsFeed 38, NpcRoster 28, MapView 28, CampaignCommunity 19 = top 5). Puffer: update the ledger entry. HP: type-away campaign, one component at a time, start with RollsFeed (hot path). Multi-week for the HP side.
...
- [ ] **[MEDIUM][PUFFER doc] AUDIT M2 - TacticalMap 14-day watch note** to debug-handoff.md §1 (post-gate polish wave: c0d9fb8/a068ffb/38e59cb/5845bfd/0599207/c3e0f10/421a4d6/aea76cd through 2026-06-13). NOT a YELLOW re-bump.
...
- [ ] **[MEDIUM][PUFFER] AUDIT M4 - "Patterns learned 2026-05-30"** subsection to debug-handoff.md §2 with the 7 new lessons + SHA chain. ~20 min.
