...
- [ ] **[MEDIUM][PUFFER audit] AUDIT M5 - realtime-wrap invariant** check; if any handler bypasses `wrapBroadcast`/`wrapDbChange`, add `scripts/check-realtime-wrap.mjs` guardrail.
...
- [ ] **[LOW][HP or PUFFER] AUDIT L3 - useEffect empty-deps triple-check** on the 3 sites; confirm not stale-closure.
