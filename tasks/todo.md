...
- [ ] **Phase 2 (6 left of 7):** ~~char-create methods~~ (DONE, #8 above), session lifecycle, combat flow+propagation, NPC roster CRUD + recruit gates, communities lifecycle + weekly check, inventory/trade, rumors publish->clone (+ ~5 small `data-testid`s).
