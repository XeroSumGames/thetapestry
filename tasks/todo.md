...
- [x] **[FIXED 2026-06-16 `550e252` + 2026-06-17 `6d86456`][HIGH] Charge "Cancel Move" didn't cancel the Charge** - Xero marked this twice: "charge when canceled is broken" (00:51:28 UTC) and "charge failed again - hit charge, hit cancel, still got the CHARGE modal and two moves" (01:01:45 UTC). Fix 1 (`550e252`): route "Cancel Move" button to `handleMapMoveCancel()`. Fix 2 (`6d86456`): defensive guard in `handleMapMoveComplete` - only honour `pendingChargeRef` when `moveMode?.feet === 20`; if the user switched to a 10-foot regular Move, any surviving charge ref is stale and cleared. Dump analysis 2026-06-17 confirmed the bug persisted through fix 1 due to a React state-timing edge case. 877 tests green. Testplan: [tasks/charge-cancel-testplan-2026-06-17.md](charge-cancel-testplan-2026-06-17.md).
