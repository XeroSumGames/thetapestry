...
- [ ] **[HIGH] Batched Phase 7 2-client acceptance** across vehicle / communities / stockpile / MapView realtime (only TacticalMap + presence smoked so far). This is the demote-gate for the Realtime YELLOW. Needs Xero (two windows). Steps: "PHASE 7 SMOKE - vehicle realtime" below + `tasks/decomposition-2client-smoke-testplan.md`.
