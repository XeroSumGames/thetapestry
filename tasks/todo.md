...
- [ ] **Phase A3 (FUNCTIONAL - canon-check/confirm first)** - Gut Instinct sub-skill DROPDOWN (today auto-best-of), Recruit who/approach/skill dropdowns folded into the modal, always-insight WIRING on Stress/Breaking Point/Lasting Wound (they didn't offer it before - roll-engine work, not chrome). These change mechanics; walk the precedence stack before building.
...
- [ ] **Phase 1 remaining (6):** messages-dm (RT), campfire-social (forum/LFG/war-story + Thriver auto-approve), presence ("Survivors present: N"), world-pin-to-queue (moderation), rules-deeplinks, account-settings.
