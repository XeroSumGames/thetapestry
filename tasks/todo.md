...
**LOW**
- [~] **L-1 Stale TODOs.** PARTIAL 2026-05-19. `lib/campaign-snapshot.ts:22` swept - the "TODO once tables are in use" was stale (tables in use across 19 files); inline comment replaced with a permanent note explaining why communities are out of snapshot scope, real work promoted to "Bigger builds" above. Still open: `app/campfire/timestamp/page.tsx:8` (Tapestry-side renderer TODO).
