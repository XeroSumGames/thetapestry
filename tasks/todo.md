...
- [ ] **Phase 1 remaining (2):** presence ("Survivors present: N"), account-settings. (LFG "I'm Interested" + war-story composer also still uncovered - moderation trigger is shared so the role-gate generalises, but those composers' UI flows are untested.)
