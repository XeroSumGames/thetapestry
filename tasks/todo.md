...
- [ ] **Stabilize Phase 4 - retire legacy executeRoll branch.** Once the 2026-05-25 playtest verifies the dedicated modal path is clean, delete the unreachable `if (pendingRoll.label.includes('Stabilize '))` block in `app/stories/[id]/table/page.tsx` (~40 lines). Mark in commit as "Phase 4 cleanup".
