  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden', fontFamily: 'Barlow, sans-serif', background: '#0f0f0f' }}>
      ...
      {showAdvanceTimeModal && (() => {
        ...
        return (
          <div onClick={() => !advanceTimeBusy && setShowAdvanceTimeModal(false)}
            style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.9)', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
            <div onClick={e => e.stopPropagation()}
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <button onClick={() => setShowAdvanceTimeModal(false)} disabled={advanceTimeBusy}
                ...
                <button onClick={async () => {
                  if (total === 0 || advanceTimeBusy) { setShowAdvanceTimeModal(false); return }
          ...
          <div onClick={e => e.stopPropagation()} style={{ background: '#1a1a1a', border: '1px solid #3a3a3a', borderRadius: '4px', padding: '1.5rem', width: '400px', maxHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              <button onClick={() => setShowRestorePicker(false)}
                style={{ flex: 1, padding: '10px', background: '#242424', border: '1px solid #3a3a3a', borderRadius: '3px', color: '#d4cfc9', fontSize: '13px', fontFamily: 'Carlito, sans-serif', letterSpacing: '.06em', textTransform: 'uppercase', cursor: 'pointer' }}>
                Cancel
              </button>
              <button onClick={async () => {
