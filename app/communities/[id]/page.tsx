...
export default function CommunityDetailPage() {
  ...
  return (
    <div style={{ maxWidth: '1040px', margin: '0 auto', padding: '1.5rem 1.5rem 4rem', fontFamily: 'Carlito, sans-serif', color: '#f5f2ee' }}>
      ...
      <div style={{ fontSize: '13px', color: '#f5f2ee', fontFamily: 'Carlito, sans-serif', letterSpacing: '.08em', textTransform: 'uppercase', marginBottom: '4px' }}>Campaign</div>
