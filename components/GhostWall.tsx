  ...
  return (
    <ModalBackdrop onClose={onClose} zIndex={10002} opacity={0.85} padding="1rem">
      <div style={{ background: '#1a1a1a', border: '2px solid #c0392b', borderRadius: '4px', padding: '2rem', width: '380px', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '14px', color: '#f5f2ee', marginBottom: '1.5rem', lineHeight: 1.5 }}>
        ...
        <div style={{ display: 'flex', gap: '8px', flexDirection: 'column' }}>
          ...
          <Link href="/login" style={{ display: 'block', padding: '10px', background: 'transparent', border: '1px solid #3a3a3a', borderRadius: '3px', color: '#f5f2ee', fontSize: '14px', fontFamily: 'Carlito, sans-serif', letterSpacing: '.08em', textTransform: 'uppercase', textDecoration: 'none', textAlign: 'center' }}>
            Sign In
          </Link>
