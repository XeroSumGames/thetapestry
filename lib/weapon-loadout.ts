...
//
// Canon (Xero, locked 2026-07-13, retuned same day after the smoke run -
// "36 bullets is wrong"): a ranged weapon's starting ammo depends on who
// carries it -
//   - PC:  a FULL clip + 1d3 reloads (a 6-round revolver = 12..24 total,
//          never 36).
...
export function rangedLoadout(
  ...
  if (role === 'pc') return { ammoCurrent: c, ammoMax: c, reloads: d3() }
