...
export const CHASED_NPCS: NpcSeed[] = [
  ...
  // THE CONNOR BOYS
  {
    ...
    wp_max: 15, rp_max: 9,
    skills: [{ name: 'Ranged Combat', level: 2, specialized: false }, { name: 'Unarmed Combat', level: 2, specialized: false }, { name: 'Manipulation', level: 1, specialized: false }, { name: 'Hunting', level: 1, specialized: false }, { name: 'Survival', level: 1, specialized: false }],
  ...
  },
  {
    ...
    reason: -1, acumen: 0, physicality: 3, influence: 0, dexterity: 2,
    wp_max: 15, rp_max: 9,
    skills: [{ name: 'Ranged Combat', level: 2, specialized: false }, { name: 'Melee Combat', level: 3, specialized: false }, { name: 'Unarmed Combat', level: 2, specialized: false }, { name: 'Manipulation', level: 1, specialized: false }],
  ...
  },
  {
    ...
    wp_max: 13, rp_max: 7,
    skills: [{ name: 'Hunting', level: 1, specialized: false }, { name: 'Manipulation', level: 2, specialized: false }, { name: 'Ranged Combat', level: 2, specialized: false }, { name: 'Stealth', level: 1, specialized: false }, { name: 'Survival', level: 1, specialized: false }],
    equipment: [{ name: 'Hunting Knife', roll: '2+1d3' }, { name: 'Shotgun', damage: 6, roll: '5+2d6' }, { name: 'Flashlight' }],
  ...
  },
  {
    ...
    wp_max: 10, rp_max: 6,
    skills: [{ name: 'Inspiration', level: 2, specialized: false }, { name: 'Manipulation', level: 2, specialized: false }, { name: 'Barter', level: 1, specialized: false }, { name: 'Hunting', level: 1, specialized: false }, { name: 'Ranged Combat', level: 1, specialized: false }, { name: 'Survival', level: 1, specialized: false }, { name: 'Tactics', level: 1, specialized: true }],
...
export const MONGRELS_NPCS: NpcSeed[] = [
  ...
  {
    name: 'The Watcher of Page',
    reason: 1, acumen: 2, physicality: 0, influence: 0, dexterity: 1,
    wp_max: 10, rp_max: 7,
    skills: [
      { name: 'Stealth', level: 2, specialized: false },
      { name: 'Survival', level: 2, specialized: false },
      { name: 'Scavenging', level: 1, specialized: false },
      { name: 'Tinkerer', level: 1, specialized: false },
    ],
    equipment: [
      { name: 'Hunting Knife', damage: 14, roll: '2+2d3' },
    ],
    role: 'Lone Survivor',
    pin_title: 'Page, AZ',
    description: 'A lone survivor living among mannequins in the abandoned town of Page. Whether the mannequin displays are a warning, a memorial, or the work of a disturbed mind is left ambiguous. Watches the convoy from the mesa but does not approach. May or may not be hostile - the players don\'t find out for certain.',
    how_to_meet: 'Day 10. Players discover Page is devoid of life but full of mannequins. Signs of a single occupant. The Watcher observes from a distance.',
    motivation: 'Solitude. Whatever happened here, the Watcher chose to stay.',
  },
  {
    name: 'Nana Ruth',
    reason: 2, acumen: 1, physicality: 0, influence: 2, dexterity: 0,
    ...
    role: 'LDS Elder',
    pin_title: 'Kanab, UT',
    description: 'An older LDS woman in Kanab who knows a cleaner distilling method. She will share it freely - but only if the players sit with her while she talks about her dead family. It costs nothing but time and the willingness to sit with grief.',
    how_to_meet: 'Days 14-15, Kanab brew day. Wild Success on the Mechanic*/Tinkerer check.',
    motivation: 'Connection. Someone to listen. The knowledge is her gift in exchange.',
  },
  {
    name: 'Cole Vickers',
    reason: 1, acumen: 1, physicality: 2, influence: 1, dexterity: 1,
    wp_max: 13, rp_max: 7,
    skills: [
      { name: 'Ranged Combat', level: 2, specialized: false },
      { name: 'Survival', level: 2, specialized: false },
    ...
    equipment: [
      { name: 'Hunting Rifle', damage: 28, roll: '5+1d6' },
      { name: 'Hunting Knife', damage: 14, roll: '2+2d3' },
    ],
    role: 'Survivalist Leader',
    pin_title: 'Cedar Breaks National Monument, UT',
    description: 'Leader of the survivalists guarding Cedar Breaks National Monument at 10,000 feet. They control reliable water. Cole is suspicious, territorial, and well-prepared - but not unreasonable if approached carefully. His people have been here a while and consider this their ground.',
    how_to_meet: 'Day 16, the approach to Cedar City. The survivalists stop the convoy on the mountain road.',
    motivation: 'Protect the water supply. Survival of his group above all else.',
  },
  {
    name: 'Brother Elias',
    reason: 2, acumen: 2, physicality: 0, influence: 2, dexterity: 0,
    wp_max: 10, rp_max: 8,
    skills: [
      { name: 'Manipulation', level: 2, specialized: false },
      { name: 'Inspiration', level: 2, specialized: false },
    ...
    equipment: [],
    role: 'Fanatic Preacher',
    pin_title: 'Fanatics Roadblock I-15 North',
    description: 'The leader of the religious fanatics who have set up a roadblock on I-15 north of Cedar City. His theology is internally coherent and deeply disturbing - he believes the Dog Flu was divine selection and that the players were chosen. The first encounter is non-violent. He is persistent, articulate, and absolutely certain.',
    how_to_meet: 'Days 17-19. First encounter at Cedar City, escalating to the roadblock ambush on Day 19.',
    motivation: 'Convert the players. Absolute faith in his interpretation of events.',
  },
  {
    name: 'Marcus Webb',
    reason: 0, acumen: 1, physicality: 1, influence: 0, dexterity: 2,
    ...
    equipment: [
      { name: 'Light Pistol', damage: 21, roll: '3+1d6' },
    ],
    role: 'Trapped Mechanic',
    pin_title: 'Idaho Falls, ID',
    description: 'Pinned under collapsed shelving in a parts warehouse. Knows Winnebago engines and can solve Minnie\'s overheating problem permanently. Wants to come to Bozeman. Complication: someone here loves him and is afraid to lose him. Freeing him without a Medicine* check risks worsening his injuries.',
    how_to_meet: 'Days 32-33, Idaho Falls gather day. Found during scavenging.',
    motivation: 'Get free. Get to Bozeman. Start over.',
  },
  {
    name: 'The Dying Traveller',
    reason: 1, acumen: 0, physicality: 0, influence: 1, dexterity: 0,
    wp_max: 3, rp_max: 2,
    skills: [
      { name: 'Survival', level: 1, specialized: false },
    ],
    equipment: [],
    role: 'Dying Survivor',
    pin_title: 'Pocatello, ID',
    description: 'Found in a raided town near Pocatello. Mortally wounded. From Bozeman - had a family there. Leaves behind a photograph. The players now know something about where they are going. It may be good news. It may not.',
    how_to_meet: 'Day 28-30, Pocatello. Found in the aftermath of a recent raid.',
    motivation: 'Get the photograph home.',
  },
  {
    name: 'Dillon Rancher',
    reason: 1, acumen: 1, physicality: 1, influence: 1, dexterity: 1,
    wp_max: 12, rp_max: 7,
    skills: [
      { name: 'Ranged Combat', level: 1, specialized: false },
      { name: 'Survival', level: 2, specialized: false },
      { name: 'Animal Handling', level: 2, specialized: false },
      { name: 'Barter', level: 1, specialized: false },
      { name: 'Farming', level: 1, specialized: false },
    ],
    equipment: [
    ...
    role: 'Working Rancher',
    pin_title: 'Dillon, MT',
    description: 'A working rancher in the Beaverhead Valley. Curious but not hostile. Has horses and beef. Hasn\'t seen a running RV in over a year. Willing to trade if the players are respectful. The valley is surrounded by eleven mountain ranges - cold, clean, and quiet.',
    how_to_meet: 'Days 35-36, Dillon gather day. Wild Success on Scavenging.',
    motivation: 'Protect his land. Cautious openness to outsiders who aren\'t trouble.',
  },
]
