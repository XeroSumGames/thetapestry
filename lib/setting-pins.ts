...
// Kings Crossroads Mall pulls the mall complex (01-07) plus Georgetown out of
...
const KINGS_CROSSROADS_MALL_PIN_TITLES = new Set([
  '01 | Best Nite Motel',
...
export const KINGS_CROSSROADS_MALL_PINS: SettingPin[] = CHASED_PINS
  .filter(p => KINGS_CROSSROADS_MALL_PIN_TITLES.has(p.title))
...
export const SETTING_PINS: Record<string, SettingPin[]> = {
  ...
  empty: CHASED_PINS,
  kings_crossroads_mall: KINGS_CROSSROADS_MALL_PINS,
}
