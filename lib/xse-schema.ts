...
export const EQUIPMENT: EquipmentItem[] = [
  ...
  { name: 'Bicycle Repair Kit',     rarity: 'Common',   enc: 0, notes: '+1 CMod when using Mechanics* or Tinkerer to repair a bike' },
  ...
  { name: 'Crowbar',                rarity: 'Common',   enc: 1, notes: '+1 to Physicality checks when opening doors' },
  { name: "Doctor's Bag",           rarity: 'Uncommon', enc: 1, notes: '+2 SMod to Medicine* checks; 1+2d3 WP/24 hours' },
  { name: 'Fire-starting Kit',      rarity: 'Common',   enc: 0, notes: '+1 CMod to Survival checks when starting a fire' },
  ...
  { name: 'Instant Camera',         rarity: 'Uncommon', enc: 1, notes: '6 Charges, can provide +1 CMod to Manipulation attempts when using pictures' },
  ...
  { name: 'Rope',                   rarity: 'Common',   enc: 1, notes: "50' length" },
  ...
  { name: 'Hunting Traps',          rarity: 'Common',   enc: 1, notes: '+2 CMod when using Survival to set traps' },
  ...
  { name: 'Weapons Toolkit',        rarity: 'Uncommon', enc: 1, notes: 'Required for Weapons maintenance and repairs; +1 CMod on Conditions checks' },
